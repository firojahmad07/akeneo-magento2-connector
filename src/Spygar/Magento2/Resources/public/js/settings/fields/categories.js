...
define(
    [
        ...
        'backbone',
        'pim/form',
        'mobikulconfiguration/template/form/categories',
    ...
    function (
        ...
        return BaseForm.extend({
            ...
            className: 'tab-pane active akeneo-mobikul-fields',
            ...
            initialize: function (config) {
                ...
                if (undefined !== config) {
                    ...
                    this.fieldName = !_.isUndefined(config.fieldName) ? config.fieldName : "categories"
                }
            ...
            loadTrees: function () {
                return $.getJSON(
                    Routing.generate(this.config.itemCategoryTreeRoute, { id: this.getFormData().id })
                ).then(function (data) {
            ...
            updateModel: function (event) {
                ...
                //     formData[this.fieldName] = categoryCodes
                // }
                formData[this.fieldName] = categoryCodes;
