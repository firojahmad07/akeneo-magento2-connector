...
/**
 *  Magento2 End point trait
 */
trait EndPointsTrait
{
    /** Magento2 API End Points */
    private $endPoints = 
    [
        'storeViews'    => [ 'url' => '/rest/V1/store/storeViews', 'method' => 'GET' ],
        'addOrUpdate'   => [ 'url' => '/rest/{_store}/V1/categories', 'method' => 'POST' ],
        'addAttributeSet'     => ['url' => '/rest/{_store}/V1/products/attribute-sets', 'method'=> 'POST'],
        'updateAttributeSet'  => ['url' => '/rest/{_store}/V1/products/attribute-sets/{ID}', 'method'=> 'PUT'],
